    ...
    <div class="container-fluid py-4">
        <div class="row">
            ...
            <div class="col-md-4">
                        ...
                        @foreach ($files as $field => $label)
                            @if ($intern->$field)
                                <div class="mb-3">
                                    ...
                                    <iframe src="{{ asset('storage/' . $intern->$field) }}" class="w-100 border mt-2"
                                        height="200"></iframe>
                                    <a href="{{ asset('storage/' . $intern->$field) }}" target="_blank"
                ...
                <a href="{{ route('intern.index', $intern) }}" class="btn btn-sm btn-info text-white">Kembali</a>
            </div>
        </div>
    </div>
</x-app-layout>